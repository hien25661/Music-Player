...
public class AccelerometerManager {
    ...
    private static float thresholdEnd  = 12.0f;
...
//                                Toast.LENGTH_SHORT).show();
                    ...
                    /*force = Math.abs(x + y + z - lastX - lastY - lastZ)
                                / timeDiff;*/
                            float valueForce = (x + y + z - lastX - lastY - lastZ);
                            force = Math.abs(x + y + z - lastX - lastY - lastZ);
                            ...
                            if (Float.compare(force, threshold) >0 ) {
                                ...
                                if (now - lastShake >= interval) {
                                    ...
                                    listener.onShake(force,(valueForce<0)?true:false);
                                    Log.e("VOK",""+(x + y + z - lastX - lastY - lastZ));
                                }
                                else
                                {
                                    Toast.makeText(aContext,"No Motion detected",
