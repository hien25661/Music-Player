...
//    public static final int FILE_KIND_NOTIFICATION = 2;
    ...
    private EditText mFilename, mParentFile;
...
//        mTypeArray.add(resources.getString(R.string.type_notification));
        ...
        mParentFile = (EditText)findViewById(R.id.parent_dir);
        ...
        if(isSDPresent) {
            ...
            parentdir = context.getFilesDir().getAbsolutePath() + "/miniclues/MusicPlayer/ringtones";
        }
        mParentFile.setText(""+parentdir);
